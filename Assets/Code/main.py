...
background_image = tk.PhotoImage(file=r"C:\Users\Roeurn.KAKI\Desktop\SA\super-mario.png")

# Create a background image on the canvas
canvas.create_image(0, 0, anchor=tk.NW, image=background_image)

# Load the player character image
player_image = tk.PhotoImage(file=r"C:\Users\Roeurn.KAKI\Desktop\SA\gen1.png")
